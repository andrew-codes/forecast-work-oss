...
test("Given I am have set a valid configuration in the Configuration Pane, when I view click the start button, then the Configuration Pane is collapsed and the throughput is visible.", async ({ electronApp }) => {
